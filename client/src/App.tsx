...
import Home from './parallaxScrollToSections/Home';
import About from './parallaxScrollToSections/About'
import ProductPost from './parallaxScrollToSections/ProductPost'
import Profile from './parallaxScrollToSections/Profile'
import Login from './parallaxScrollToSections/Login';
import Signup from './parallaxScrollToSections/Signup'
import Footer from "./components/Footer/Footer";
import GuestRoute from './components/GuestRoute';
import PrivateRoute from './components/PrivateRoute';
import { useAuthTokenStore}  from "./utils/auth";
import AllArtworks from "./parallaxScrollToSections/AllArtworks";
import AllArtworksByUser from "./parallaxScrollToSections/AllArtworksByUser";
